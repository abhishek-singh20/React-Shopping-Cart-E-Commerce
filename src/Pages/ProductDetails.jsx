        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-1">
          <div className="w-full">
            <img
              src={product.image}
              alt={product.name}
              className="w-[300px] h-[300px] object-cover rounded-2xl shadow-2xl shadow-gray-950/50 border-4 border-gray-800"
            />
          </div>
          ...
          <div className="flex-col justify-between">
            ...
            <p className="text-3xl font-extrabold text-orange-400 mb-4">₹{product.price.toFixed(2)}

            </p>
            <h2 className="text-xl font-bold text-gray-200 mb-2 border-b border-e-orange-900/50 pd-2 flex items-center space-x-2">
            ...
            <ul className="space-y-3 text-gray-300 p-4 bg-gray-800 rounded-xl border border-gray-700">
              ...
              <li className="flex items-center space-x-3 text-lg">
                <Zap className="w-5 h-5 text-orange-500" />
                <span>Comprehensive 1-Year Manufacturer Materials</span>
              </li>
              <li className="flex items-center space-x-3 text-lg">
                <Zap className="w-5 h-5 text-orange-500" />
            ...
            <div className="mt-5 space-y-4 flex justify-center items-center flex-col">
              ...
              <Link to={'/'} className="w-full py-3 border border-orange-600 text-orange-400 font-bold rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider">
                Keep Shopping
              </Link>
