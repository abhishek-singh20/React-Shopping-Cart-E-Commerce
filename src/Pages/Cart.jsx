  ...
  return <>
    <div className="container mx-auto px-4 md:py-8 pt-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-1 p-8 bg-gray-900 rounded-2xl shadow-2xl border -1-4 sticky top-20 h-fit border border-gray-800">
          ...
          <div className="space-y-4 text-gray-400">
            ...
            <div className="flex justify-between pt-6 border-t border-gray-700">
              <span className="text-2xl font-extrabold text-white">Estimate (Total) :</span>
        ...
        <Link
  to="/checkout"
  className="w-full mt-3 py-3 bg-orange-600 text-white font-bold text-x2 rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-1 transform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider"
>
  <Zap className="w-5 h-5" />
  <span> ProceedSecurely </span>
</Link>
