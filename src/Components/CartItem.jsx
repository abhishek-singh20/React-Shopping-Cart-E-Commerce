...
const CartItem = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-4 w-full sm:-auto">
      ...
      <div className="flex items-center justify-between sm:justify-end w-full sm:w sm:w-2/5 sm:mt-0 space-x-4">
        <div className="flex items-center border border border-gray-700 rounded-full overflow-hidden shadow-lg">
        <button
  onClick={decreaseQ}
  className="flex items-center justify-center p-2 text-gray-400 bg-gray-800 hover:bg-gray-700 transition duration-150 w-8 h-8 rounded-lg"
>
  -
</button>

          <span className="px-3 gext-base font-bold text-white bg-gray-800">
            {item.quantity}
            </span>
